...
Status below reflects the repo state and validated captures as of 2026-05-21.

| Model | Result |
|---|---|
| Instax Evo Wide (FI028, Gen 2) | Print, live view, flash control, remote-shoot auto-transfer, and manual download all working |
